...
const DateRangePicker = ({
    ...
    const node = (
        <View>
            <TouchableWithoutFeedback onPress={_onOpen}>{children ? children : <View />}</TouchableWithoutFeedback>
        </View>
    );
                    ...
                    <View style={mergedStyles.container}>
                        <View style={styles.header}>
                            <TouchableOpacity onPress={previousMonth}>
                                {monthPrevButton || (
                                    <Image resizeMode="contain" style={mergedStyles.monthButtons} source={chevronL} />
                                )}
                            </TouchableOpacity>
                            ...
                            <TouchableOpacity onPress={nextMonth}>
                                {monthNextButton || (
                                    <Image resizeMode="contain" style={mergedStyles.monthButtons} source={chevronR} />
                                )}
                            </TouchableOpacity>
                        </View>
