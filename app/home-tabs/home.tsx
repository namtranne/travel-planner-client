                ...
                <ScrollView showsHorizontalScrollIndicator={false}>
                    <SafeAreaView>
                        <View className="w-full px-6 pt-4">
                            ...
                            <Text className="mt-10 font-inter text-3xl font-bold">
                                {t('Ready to plan your next trip?')}
                            </Text>
                            <TouchableOpacity
                            ...
                            >
                                <View className="flex-1 pr-[2px]">
                                    <Text className="font-inter text-sm font-bold">{t('Start planning now!')}</Text>
                                    <Text className="font-inter text-xs">
                                        {t('Create a perfect plan in just a few clicks')}
                                    </Text>
                                </View>
